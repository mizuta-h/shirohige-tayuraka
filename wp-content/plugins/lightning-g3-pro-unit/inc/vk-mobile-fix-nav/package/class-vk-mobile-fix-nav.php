...
if ( ! class_exists( 'Vk_Mobile_Fix_Nav' ) ) {
	...
	class Vk_Mobile_Fix_Nav {
		...
		public static function widgets_init() {
			register_sidebar(
				array(
					'name'          => __( 'Widget area of mobile fix nav', 'lightning-g3-pro-unit' ),
		...
		public function vk_mobil_fix_nav_customize_register( $wp_customize ) {
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => $vk_mobile_fix_nav_prefix . __( 'Mobile Fix Nav', 'lightning-g3-pro-unit' ),
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[hidden]',
				array(
					'label'    => __( 'Do not display Mobile Fix Nav', 'lightning-g3-pro-unit' ),
			...
			$wp_customize->add_control(
				new MobileNav_Custom_Html(
					...
					'nav_title_widget',
					array(
						'label'            => __( 'Mobile Fix Nav Widget Area', 'lightning-g3-pro-unit' ),
						'section'          => 'vk_mobil_fix_nav_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[widget_padding]',
				array(
					'label'    => __( 'Add Widget Area Padding', 'lightning-g3-pro-unit' ),
					'section'  => 'vk_mobil_fix_nav_setting',
			...
			$wp_customize->add_control(
				new MobileNav_Custom_Html(
					...
					'nav_title_0',
					array(
						'label'            => __( 'Add menu open and close button', 'lightning-g3-pro-unit' ),
						'section'          => 'vk_mobil_fix_nav_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'vk_mobil_fix_nav_options[add_menu_btn]',
				array(
					'label'       => __( 'Add menu open and close button to first.', 'lightning-g3-pro-unit' ),
					'section'     => 'vk_mobil_fix_nav_setting',
					'settings'    => 'vk_mobil_fix_nav_options[add_menu_btn]',
					'type'        => 'checkbox',
					'description' => __( '* When using Font Awesome 5 SVG, the icon does not switch at menu open.', 'lightning-g3-pro-unit' ),
				)
			);
			...
			if ( isset( $add_menu_btn ) && $add_menu_btn == true ) {
				...
				$wp_customize->add_control(
					'link_text_0',
					array(
						'label'    => __( 'Link text:', 'lightning-g3-pro-unit' ),
						'section'  => 'vk_mobil_fix_nav_setting',
			...
			for ( $i = 1; $i <= $menu_num; $i ++ ) {
				...
				$wp_customize->add_control(
					new MobileNav_Custom_Html(
						...
						'nav_title_' . $i,
						array(
							'label'            => __( 'Fix Navi button', 'lightning-g3-pro-unit' ) . ' [ ' . $i . ' ]',
							'section'          => 'vk_mobil_fix_nav_setting',
							'type'             => 'text',
							'custom_title_sub' => '',
							'custom_html'      => '',
				...
				$wp_customize->add_control(
					'link_icon_' . $i,
					array(
						'label'       => __( 'Font Awesome icon font', 'lightning-g3-pro-unit' ),
						'section'     => 'vk_mobil_fix_nav_setting',
						'settings'    => 'vk_mobil_fix_nav_options[link_icon_' . $i . ']',
						'type'        => 'text',
						'description' => __( 'To choose your favorite icon, and enter the icon html tag.', 'lightning-g3-pro-unit' ) . '<br>' . $description,
					)
				);
				...
				$wp_customize->add_control(
					...
					array(
						...
						'type'        => 'text',
						'description' => __( 'Ex', 'lightning-g3-pro-unit' ) . ') https://vccw.text/',
					)
				);
				...
				$wp_customize->add_control(
					'vk_mobil_fix_nav_options[link_blank_' . $i . ']',
					array(
						'label'    => __( 'Open link new tab.', 'lightning-g3-pro-unit' ),
						'section'  => 'vk_mobil_fix_nav_setting',
				...
				$wp_customize->add_control(
					'event_' . $i,
					array(
						'label'       => __( 'Click event:', 'lightning-g3-pro-unit' ),
						'section'     => 'vk_mobil_fix_nav_setting',
						'settings'    => 'vk_mobil_fix_nav_options[event_' . $i . ']',
						'type'        => 'text',
						'description' => __( 'Ex', 'lightning-g3-pro-unit' ) . " ) gtag('event', 'play', { 'event_category': 'Videos', 'event_label': 'Fall Campaign'});",
					)
				);
				...
				$wp_customize->add_control(
					new MobileNav_Custom_Html(
						...
						'nav_common',
						array(
							'label'            => __( 'Navi Common Settings', 'lightning-g3-pro-unit' ),
							'section'          => 'vk_mobil_fix_nav_setting',
							'type'             => 'text',
							'custom_title_sub' => '',
							'custom_html'      => '',
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'current_color',
					array(
						'label'    => __( 'Current Color:', 'lightning-g3-pro-unit' ),
						'section'  => 'vk_mobil_fix_nav_setting',
