...
if ( ! class_exists( 'Vk_Font_Selector' ) ) {
	...
	class Vk_Font_Selector {
		...
		public static function fonts_array() {
			$fonts_array = array(
				''                      => array(
					'label'       => __( 'Unspecified', 'lightning-g3-pro-unit' ),
					'font-family' => '',
				),
				'mincho'                => array(
					'label'       => __( 'Mincho', 'lightning-g3-pro-unit' ),
					'font-family' => 'Hiragino Mincho ProN,"游明朝",serif',
				),
				'hira-kaku'             => array(
					'label'       => __( 'Hiragino Kaku Gothic', 'lightning-g3-pro-unit' ),
				...
				'yu-gothic'             => array(
					'label'       => __( 'Yu Gothic', 'lightning-g3-pro-unit' ),
					'font-family' => '"游ゴシック Medium","Yu Gothic Medium","游ゴシック体",YuGothic,"ヒラギノ角ゴ ProN W3", Hiragino Kaku Gothic ProN,sans-serif',
				),
				'meiryo'                => array(
					'label'       => __( 'Meiryo', 'lightning-g3-pro-unit' ),
					'font-family' => '"メイリオ",Meiryo,"ヒラギノ角ゴ ProN W3", Hiragino Kaku Gothic ProN,sans-serif',
				),
				'san-francisco'         => array(
					'label'       => __( 'San Francisco', 'lightning-g3-pro-unit' ),
		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->add_section(
				...
				array(
					'title'    => $vk_font_selector_prefix . __( 'Font Setting', 'lightning-g3-pro-unit' ),
			...
			$html  = '<ul>';
			$html .= '<li>' . __( 'If you want to apply the same font on mobile devices, please select web font (Google Fonts).', 'lightning-g3-pro-unit' ) . '</li>';
			$html .= '<li>' . __( 'The web font (Google Fonts) loads the font data, so the display will be slightly late.', 'lightning-g3-pro-unit' ) . '</li>';
			$html .= '</ul>';
			...
			foreach ( $targets as $key => $label ) {
				...
				$wp_customize->add_control(
					'vk_font_selector[' . $key . ']',
					array(
						'label'    => __( $label . ':', 'lightning-g3-pro-unit' ),
						'section'  => 'vk_font_selector_related_setting',
						'settings' => 'vk_font_selector[' . $key . ']',
						'type'     => 'select',
						'choices'  => $choices,
					// 'choices'  => array(
					// 'mincho' => __( 'Mincho', 'lightning-g3-pro-unit' ),
					// 'gothic' => __( 'Gothic', 'lightning-g3-pro-unit' ),
					// ),
					)
				);
			}
		...
		public static function get_selected_fonts_info() {
			...
			// ),
			// 'gothic' => array(
			// 'label' => __( 'Gothic','lightning-g3-pro-unit'),
